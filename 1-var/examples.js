document.addEventListener("DOMContentLoaded", () => { // this is the vanilla JS version of jQuery's `$(document).ready()`
    ...
    // favouriteNumber = 3;
    // console.log(`My ~updated~ favourite number is: ${favouriteNumber}`);

    // // we can even redefine the same var variable without error
    // var favouriteNumber = 7;
    // console.log(`My ~redeclared~ favourite number is: ${favouriteNumber}`);

    // // if we declare the variable inside a function, it's function-scoped:
    // function printFavouriteNumber() {
    //     var favouriteNumber = 2;
    //     console.log(`My ~printFavouriteNumber~ function returns: ${favouriteNumber}`); // let's call this 'example 1'
    // }
    
    // printFavouriteNumber();
    // console.log(`Even though the variable with the ~same name~ is still: ${favouriteNumber}`); // let's call this 'example 2'
